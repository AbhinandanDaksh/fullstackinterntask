          ...
          {activeTab === "weather" && weatherData && (
            <div>
              <button onClick={toggleUnit} className="flex justify-center items-center">
                <h1 className="flex text-xl font-semibold pt-1">
                  Switch to {unit === "metric" ? <img src={fahrenheit} alt="Fahrenheit" /> : <img src={celsius} alt="Celsius" />}
                </h1>
              </button>
              ...
              {error ? (
                ...
                <div className="flex flex-col justify-center items-center gap-2 pt-2">
                  ...
                  <p>Temp: {weatherData.main.temp}°{unit === "metric" ? "C" : "F"}</p>
                  <p>Min: {weatherData.main.temp_min}°{unit === "metric" ? "C" : "F"} | Max: {weatherData.main.temp_max}°{unit === "metric" ? "C" : "F"}</p>
                  ...
                  <h2 className="text-xl font-semibold uppercase mt-5 bg-white p-3 rounded-md gap-1">
                    Upcoming forecast for <p className="text-[#9836B3] text-center">{weatherData?.name}</p>
                  </h2>
